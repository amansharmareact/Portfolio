  ...
  const submitData = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://my-portfolio-41f94-default-rtdb.firebaseio.com/ContactData.json",
        {
          method: "POST",
          headers: {
      ...
      <div className="pt-40" style={{ background: "#FFD1E3" }}>
        <div className="flex items-center flex-wrap justify-between px-16">
          <div className="lg:w-1/2 lg:text-start text-center wow fadeInUpjyu">
            <h2 className="text-5xl font-extrabold mb-5 text-left	">
              Let's get in touch
            </h2>
            ...
            <ul className="social-icons social-icons-lg justify-content-center lg:justify-content-start mt-5">
              ...
              <li className="social-icons-instagram">
                <a
                  href="https://www.instagram.com/_amanxharma"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li className="social-icons-github">
                <a
                  href="https://github.com/amansharmareact"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div
            className="lg:w-1/2 lg:mt-0 wow fadeInUp"
            data-wow-delay="0.3s"
            style={{ visibility: "visible", animationDelay: "0.3s" }}
          >
            <h2 className="text-5xl font-extrabold text-center lg:text-start mb-5">
